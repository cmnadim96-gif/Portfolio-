...
export default function App() {
  ...
  return (
    <div id="root-viewport" className="min-h-screen relative mesh-bg grid-bg pb-12">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 relative flex justify-center">
              ...
              <div className="absolute w-[350px] h-[350px] sm:w-[450px] sm:h-[450px] bg-gradient-to-tr from-[#3a86ff]/20 to-blue-500/10 rounded-full animate-float-slow -z-10 filter blur-xl border border-white/5" />
      ...
      {socialLinks.whatsapp && (
        ...
        >
          ...
          <div className="relative flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#20ba56] text-white rounded-full shadow-2xl transition-all duration-300 hover:scale-110 active:scale-95 cursor-pointer">
            {/* Pulsing ring */}
